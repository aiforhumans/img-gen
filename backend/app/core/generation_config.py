...
class GenerationConfig(BaseModel):
    ...
    model: str = Field(default="auto", description="Model backend ID (or 'auto')")
    mode: str = Field(default="auto", description="Generation mode: auto, photo, creative, design, edit")
    ...
    steps: int = Field(default=20, ge=1, le=150, description="Denoising inference steps")
    guidance: float = Field(default=7.0, ge=0.0, le=30.0, description="CFG guidance scale")
